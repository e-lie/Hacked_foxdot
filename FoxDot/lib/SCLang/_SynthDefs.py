...
if len(os.path.realpath(FOXDOT_ROOT + "/osc/scsyndef")) == 0:
    print("Your synths are gone. Let us create the basic synths")
    ...
    synths_list = ['play1', 'play2', 'abass', 'acidbass', 'alva', 'ambi', 'angel', 'angst', 'bass',
                   ...
                   'cs80lead', 'combs', 'dafbass', 'dbass', 'dblbass', 'dirt',
                   'donkysub', 'donorgan', 'dopple', 'drone', 'dustv', 'ebass',
                   'ecello', 'eeri', 'eoboe', 'epiano', 'faim', 'faim2',
                   'fbass', 'filthysaw', 'flute', 'fm', 'fmbass', 'fmrhodes',
                   'garfield', 'glitchbass', 'glitcher', 'grat', 'gray', 'gsynth',
                   'harp', 'hnoise', 'hoover', 'kalimba', 'keys', 'ladder', 'lapin',
                   'laserbeam', 'latoo', 'lazer', 'lfnoise', 'linesaw', 'longsaw',
                   'mhpad', 'mhping', 'moogbass', 'moogpluck', 'moogpluck2', 'mpluck',
                   'noisynth', 'noquarter', 'organ', 'organ2', 'pads', 'pasha',
                   'phazer', 'pianovel', 'pink', 'pmcrotal', 'ppad', 'prayerbell',
                   'prof', 'prophet', 'radio', 'rhodes', 'rhpiano', 'risseto',
                   'rissetobell', 'rlead', 'rsaw', 'rsin', 'sawbass', 'scatter',
                   'shore', 'sillyvoice', 'sine', 'sinepad', 'siren', 'spacesaw',
                   'sos', 'sosbell', 'space', 'spick', 'sputter', 'square', 'ssaw',
    ...
    for i in range(len(synths_list)):
        synth = synths_list[i]
        globals()[synth] = FileSynthDef(synth)
        globals()[synth].add()
